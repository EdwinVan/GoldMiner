...
Scene {
    ...
    property int targetmoney1: 1500 //第1关目标金币
...
//      debugDrawVisible: true // enable this for physics debugging启用它用于进行调试
    ...
    Timer {
        ...
        onTriggered:{
            time--;
            if(time==0 && money<targetmoney1) {timeOut()}
            else if(time==0 && money>=targetmoney1){
                reachTarget()
            }
        }
    }
    ...
    Gold {
        ...
        height: 70
        visible: true
        x: Math.random()*100+689
        y: Math.random()*100+523
        onContact: {
    ...
    Gold {
        ...
        height: 70
        visible: true
        x: Math.random()*100+1200
        y: Math.random()*100+339
        onContact: {
    ...
    Gold {
        ...
        height: 100
        visible: true
        x: Math.random()*100+889
        y: Math.random()*100+567
        onContact: {
    ...
    Stone {
        ...
        height: 50
        visible: true
        x: Math.random()*100+432
        y: Math.random()*100+678
        onContact: {
